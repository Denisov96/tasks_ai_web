...
export function getLogoutHeaders() {
  return {
    "Set-Cookie": [
      `accessToken=deleted; HttpOnly; Path=/; Max-Age=0; SameSite=Lax; Secure`,
      `refreshToken=deleted; HttpOnly; Path=/; Max-Age=0; SameSite=Lax; Secure`,
    ],
